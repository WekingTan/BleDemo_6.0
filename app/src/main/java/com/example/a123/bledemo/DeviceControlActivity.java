...
public class DeviceControlActivity extends AppCompatActivity {
    ...
    private final ServiceConnection mServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder service) {
            //(BluetoothLeService.LocalBinder) service 通过向下转型得到 LocalBinder 实例，执行 getService() 后，返回 BluetoothLeService.this
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //绑定 BluetoothLeService 服务，其中 BIND_AUTO_CREATE 表示活动和服务进行绑定后自动创建服务
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_connect_disconnect, menu);
        if (mConnected) {
